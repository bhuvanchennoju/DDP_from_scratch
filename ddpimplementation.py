...
def ddp_setup():
    ...
    logging.info(f"Rank {os.environ['RANK']} | Local Rank {os.environ['LOCAL_RANK']} | World Size {os.environ['WORLD_SIZE']} | Master {os.environ['MASTER_ADDR']}:{os.environ['MASTER_PORT']}")
...
class Trainer:
    ...
    def _run_epoch(self, epoch):
        ...
        logging.info(f"[GPU{self.global_rank}] Epoch {epoch} | Batchsize: {b_sz} | Steps: {len(self.train_data)}")
...
def load_train_objs():
    train_set = MyTrainDataset(32000) 
